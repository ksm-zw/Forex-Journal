...
"[project]/src/app/api/analytics/period-analysis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const grouped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$analytics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["groupTradesByPeriod"])(trades, period);
        const analysis = {};
        for(const periodKey in grouped){
            analysis[periodKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$analytics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["periodMetrics"])(grouped[periodKey]);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            period,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c1970e85._.js.map